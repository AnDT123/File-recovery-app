...
namespace Tool {
	...
	std::unique_ptr <MFT_RECORD_ATTRIBUTE> MFTRecordAttributeParser(unsigned char buffer[], int offset, bool* success, int* attributeLength,int bytesPerFileRecordSegment);
